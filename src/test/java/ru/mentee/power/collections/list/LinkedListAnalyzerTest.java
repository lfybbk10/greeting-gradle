...
public class LinkedListAnalyzerTest {
    ...
    void shouldThrowExceptionForNullArgumentsInMergeLists() {
        assertThatThrownBy(() -> LinkedListAnalyzer.mergeLists(null, null)).isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void shouldThrowExceptionForNullArgumentInReverse() {
        assertThatThrownBy(() -> LinkedListAnalyzer.reverse(null)).isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void shouldThrowExceptionForNullArgumentInRemoveDuplicates() {
        assertThatThrownBy(() -> LinkedListAnalyzer.removeDuplicates(null)).isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void shouldThrowExceptionForNullArgumentInRotate() {
        assertThatThrownBy(() -> LinkedListAnalyzer.rotate(null, 2)).isInstanceOf(IllegalArgumentException.class);
    }
}