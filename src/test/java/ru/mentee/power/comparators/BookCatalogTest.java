...
public class BookCatalogTest {
    ...
    void sortBooksByAuthorShouldSortByAuthor() {
        ...
        assertThat(sorted).isNotNull().hasSize(4).contains(book3, book2, book1, book4);
    }
    ...
    void sortBooksByYearPublishedShouldSortByYear() {
        ...
        assertThat(sorted).isNotNull().hasSize(4).contains(book2, book1, book4, book3);
    }
    ...
    void sortBooksByPageCountShouldSortByPageCount() {
        ...
        assertThat(sorted).isNotNull().hasSize(4).contains(book3, book2, book4, book1);
    }
